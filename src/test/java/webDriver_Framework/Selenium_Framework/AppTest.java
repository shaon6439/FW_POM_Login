...
public class AppTest {
	...
	public void valid_application() throws IOException {
		...
		ExtentSparkReporter sparkreport = new ExtentSparkReporter("C:\\selenium_Demo\\Selenium_Framework\\target\\report.html");
		...
		test.log(Status.PASS, "user launched to the browser");
